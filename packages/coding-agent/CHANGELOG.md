...
- Added this session's account usage (the same report as `/usage`) to the end of the current profile's preview in the Profiles tab ([#12993](https://github.com/can1357/oh-my-pi/pull/12993) by [@Vortex727](https://github.com/Vortex727))
