...
- Added this session's quota per provider (from the same data as `/usage`) to the end of the current profile's overview in the Profiles tab ([#12993](https://github.com/can1357/oh-my-pi/pull/12993) by [@Vortex727](https://github.com/Vortex727))
